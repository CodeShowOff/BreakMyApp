...
export function CreateProjectModal({ organizationId }: { organizationId: string | null }) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const result = await createProjectAction(organizationId, name);
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
          <div className="bg-neutral-900 border border-neutral-800 rounded-xl w-full max-w-md overflow-hidden shadow-2xl">
            <div className="px-6 py-4 border-b border-neutral-800 flex justify-between items-center">
              <h3 className="text-sm font-black tracking-widest uppercase text-white">Create New Project</h3>
              <button 
